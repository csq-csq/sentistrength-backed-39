...
public class WekaMachineLearning {
    ...
    public static void main(String[] args) throws Exception {
        WekaMachineLearning wekaMachineLearning = new WekaMachineLearning();
        wekaMachineLearning.runWekaMachineLearning(args);
    }

    public void runWekaMachineLearning(String[] args) throws Exception{
