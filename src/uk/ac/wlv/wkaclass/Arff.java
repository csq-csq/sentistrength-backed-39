...
public class Arff {
     ...
     * 分割、获取文本中的短语
     *
     * @param sLabelledTextFile    被标记的文本
     * @param iClassType           短语长度类型
     * @param iNGrams              长短语单词数
     * @param iMinFeatureFrequency 最小特征频率
     * @param iMaxFeatures         最大特征值
     * @param sUnlabelledTextFile  未标记的文本
     * @return sResults 单词组
     */
     ...
     * 对目标文件进行分析和输出
     *
     * @param sSentiTextFileIn     文件路径
     * @param sArffFileOut         数据输出路径
     * @param bHeaderLine          是否为标题行
     * @param textParsingOptions   文本解析选项
     * @param classOptions         类别选项
     * @param resources            类别源数据
     * @param iSentimentType       情绪类型
     * @param iMinFeatureFrequency 最小特征频率
     * @param arffStringIndex      文本度量
     * @return true
     */
     ...
     * 混合已标记和未标记的文本
     *
     * @param sLabelledTextFileIn   已标记的文本文件路径
     * @param sUnlabelledTextFileIn 未标记的文本文件路径
     * @param sTextFileOut          输出路径
     */
     ...
     * @param iMinFeatureFrequency 最小特征频率
     * @param bArffIndex           是否已度量
     * @param bArffIndexEntryUsed  是否有可用的检索条目
     * @param wWriter              写缓冲区
     * @return 是否完成操作
     */
