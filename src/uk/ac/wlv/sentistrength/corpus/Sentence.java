...
public class Sentence {
    ...
    /**
     * 将句式添加到未使用术语分类索引中
     * @param unusedTermClassificationIndex  未使用术语分类索引
     */
     ...
     * @param textParsingOptions 文本分析选项类
     * @param bRecordCount        是否已有记录
     * @param bArffIndex         是否在短语索引中
     * @return 完成检验的字符串数量
     */
     ...
     *  设置句式属性
     * @param sSentence 句式
     * @param classResources   资源汇总类
     * @param newClassificationOptions   新的分类选项类
     */
    ...
    /**
     *
     * @param recalculateIfAlreadyDone
     */
