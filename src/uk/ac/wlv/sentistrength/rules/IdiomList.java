...
public class IdiomList {
     ...
     *
     * @param sIdiom                                          新熟语
     * @param iIdiomStrength                                  熟语的情绪强度
     * @param bConvertIdiomStringsToWordListsAfterAddingIdiom 是否在添加新熟语后重排列表
     * @return 是否添加成功
     */
